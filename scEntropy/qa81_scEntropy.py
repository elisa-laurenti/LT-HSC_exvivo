...
meta = pd.read_csv('QA81_meta_after_qc.csv',index_col=0)
counts = pd.read_csv('counts_qa81__norm10k_noLOG.csv',index_col=0)
...
meta.to_csv('meta_qa81_only__scEntropy_scores.csv')
