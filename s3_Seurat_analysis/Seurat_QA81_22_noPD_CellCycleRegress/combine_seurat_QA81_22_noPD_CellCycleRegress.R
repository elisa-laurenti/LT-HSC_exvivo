...
qa81 <- readRDS('seurat_QA_81_281cells__CellCycleRegress.rds')

qa22 <- readRDS('seurat_QA_22_148cells__CellCycleRegress.rds')
...
saveRDS(seurat.combined.sct, 'seurat.combined.QA81_22__CellCycleRegress.rds')
