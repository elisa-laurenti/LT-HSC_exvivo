...
seurat.combined.sct = readRDS('seurat.combined.QA81_22_pca_umap_PD__CycleRegress.rds')
...
data_cds <- order_cells(data_cds, 
                        ...
                        root_cells = c('SLX.16064.i709_i506-0'))

plot_cells(
  cds = data_cds,
  color_cells_by = "pseudotime",
  show_trajectory_graph = TRUE
)+ggtitle('QA81_22 PD cycleRegress')

saveRDS(data_cds,'QA81_22_PD__cycleRegress_monocle3_pseudotime.rds')
