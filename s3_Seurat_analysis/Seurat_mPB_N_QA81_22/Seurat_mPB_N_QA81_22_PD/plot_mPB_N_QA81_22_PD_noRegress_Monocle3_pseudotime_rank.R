...
meta_plot = read.csv('meta_PD_QA81_22_N_mPB__UMAP_forPlotting.csv',row.names=1)

meta_pseudo = read.csv('meta_PD_QA81_22_N_mPB__noRegress_pseudotime_monocle3.csv',row.names=1)
...
ggplot(meta_pseudo, aes(x=pseudotime_2D_rank, color=timepoints)) +
  geom_density()+ggtitle('PD_QA81_22_N_mPB__noRegress pseudotime 2D ranking density')+ 
