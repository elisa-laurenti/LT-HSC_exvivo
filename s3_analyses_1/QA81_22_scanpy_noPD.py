...
sc.pp.combat(data_81_22,covariates=['Details'])    # Details == timepoint information


###############################
# saving check point
###############################
sc.write('QA81_22_scanpy_noPD_object_1',data_81_22)
...
# saving check point
###############################
sc.write('QA81_22_scanpy_noPD_object_2', data_neighbor)
