...
meta = pd.read_csv('QA22_meta_original.csv',index_col=0)
...
raw_adata = smqpp.read_in_files(Indir='QA22_raw_counts.csv', 
                                ftable=ftable,
                                method = 'HTSeqcount')


meta = meta.loc[raw_adata.obs_names,]
...
threshold_qc  = {'nMapped (log10)': np.log10(330000),
           'nNuclear (log10)': np.log10(276500),
           'fGenes:nTotal': 0.342,
           'nHCGenes': 2100,
           'nNuclear:nMapped': 0.818
          }
...
sc.write('QA22_after_qc.h5ad',adata_qc)
